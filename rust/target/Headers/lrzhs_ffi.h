...
int32_t lrzhs_branch_id_for_height(int32_t height, uint32_t network_id);

/**
 * Clears the record of the last error message.
 */
void lrzhs_clear_last_error(void);
 ...
 */
FFIBinaryKey *lrzhs_create_account(const uint8_t *db_data,
 ...
 *   documentation of pointer::offset.
 */
int64_t lrzhs_create_to_address(const uint8_t *db_data,
                                uintptr_t db_data_len,
 ...
 *   documentation of pointer::offset.
 */
int32_t lrzhs_decrypt_and_store_transaction(const uint8_t *db_data,
                                            uintptr_t db_data_len,
                                            const uint8_t *tx,
                                            uintptr_t tx_len,
 ...
 *   you are finished using it.
 */
FFIBinaryKey *lrzhs_derive_spending_key(const uint8_t *seed,
                                        uintptr_t seed_len,
                                        int32_t account,
                                        uint32_t network_id);
 ...
 *   pointer::offset.
 */
int32_t lrzhs_error_message_utf8(char *buf, int32_t length);
 ...
 */
void lrzhs_free_binary_key(FFIBinaryKey *ptr);
 ...
 */
void lrzhs_free_keys(FFIEncodedKeys *ptr);
 ...
 */
void lrzhs_free_typecodes(uint32_t *data, uintptr_t len);
 ...
 */
bool lrzhs_get_address_metadata(const char *address,
 ...
 *   documentation of pointer::offset.
 */
int64_t lrzhs_get_balance(const uint8_t *db_data,
                          uintptr_t db_data_len,
                          int32_t account,
                          uint32_t network_id);
 ...
 *   when done using it.
 */
char *lrzhs_get_current_address(const uint8_t *db_data,
                                uintptr_t db_data_len,
                                int32_t account,
                                uint32_t network_id);
 ...
 *   documentation of pointer::offset.
 */
int32_t lrzhs_get_nearest_rewind_height(const uint8_t *db_data,
                                        uintptr_t db_data_len,
                                        int32_t height,
                                        uint32_t network_id);
 ...
 *   when done using it.
 */
char *lrzhs_get_next_available_address(const uint8_t *db_data,
                                       uintptr_t db_data_len,
                                       int32_t account,
                                       uint32_t network_id);
 ...
 */
bool lrzhs_get_received_memo(const uint8_t *db_data,
                             uintptr_t db_data_len,
                             int64_t id_note,
 ...
 *   when done using it.
 */
char *lrzhs_get_received_memo_as_utf8(const uint8_t *db_data,
                                      uintptr_t db_data_len,
                                      int64_t id_note,
                                      uint32_t network_id);
 ...
 *   when done using it.
 */
char *lrzhs_get_sapling_receiver_for_unified_address(const char *ua);
 ...
 * - `memo_bytes_ret` must be non-null and must point to an allocated 512-byte region of memory.
 */
bool lrzhs_get_sent_memo(const uint8_t *db_data,
                         uintptr_t db_data_len,
                         int64_t id_note,
                         uint8_t *memo_bytes_ret,
                         uint32_t network_id);
 ...
 *   when done using it.
 */
char *lrzhs_get_sent_memo_as_utf8(const uint8_t *db_data,
                                  uintptr_t db_data_len,
                                  int64_t id_note,
                                  uint32_t network_id);
 ...
 * - The memory referenced by `address` must not be mutated for the duration of the function call.
 */
int64_t lrzhs_get_total_transparent_balance(const uint8_t *db_data,
                                            uintptr_t db_data_len,
                                            const char *address,
                                            uint32_t network_id);
 ...
 * - The memory referenced by `address` must not be mutated for the duration of the function call.
 */
int64_t lrzhs_get_total_transparent_balance_for_account(const uint8_t *db_data,
                                                        uintptr_t db_data_len,
                                                        uint32_t network_id,
                                                        int32_t account);
 ...
 *   when done using it.
 */
char *lrzhs_get_transparent_receiver_for_unified_address(const char *ua);
 ...
 */
uint32_t *lrzhs_get_typecodes_for_unified_address_receivers(const char *ua, uintptr_t *len_ret);
 ...
 *   documentation of pointer::offset.
 */
int64_t lrzhs_get_verified_balance(const uint8_t *db_data,
                                   uintptr_t db_data_len,
                                   int32_t account,
                                   uint32_t network_id,
                                   uint32_t min_confirmations);
 ...
 * - The memory referenced by `address` must not be mutated for the duration of the function call.
 */
int64_t lrzhs_get_verified_transparent_balance(const uint8_t *db_data,
                                               uintptr_t db_data_len,
                                               const char *address,
                                               uint32_t network_id,
                                               uint32_t min_confirmations);
 ...
 * - The memory referenced by `address` must not be mutated for the duration of the function call.
 */
int64_t lrzhs_get_verified_transparent_balance_for_account(const uint8_t *db_data,
                                                           uintptr_t db_data_len,
                                                           uint32_t network_id,
                                                           int32_t account,
                                                           uint32_t min_confirmations);
 ...
 *   documentation of pointer::offset.
 */
bool lrzhs_init_accounts_table_with_keys(const uint8_t *db_data,
                                         uintptr_t db_data_len,
 ...
 *   function call.
 */
int32_t lrzhs_init_blocks_table(const uint8_t *db_data,
                                uintptr_t db_data_len,
                                int32_t height,
                                const char *hash_hex,
                                uint32_t time,
 ...
 *   of pointer::offset.
 */
int32_t lrzhs_init_data_database(const uint8_t *db_data,
                                 uintptr_t db_data_len,
                                 const uint8_t *seed,
                                 uintptr_t seed_len,
                                 uint32_t network_id);
 ...
 */
bool lrzhs_is_valid_sapling_extended_spending_key(const char *extsk, uint32_t network_id);
 ...
 * - The memory referenced by `address` must not be mutated for the duration of the function call.
 */
bool lrzhs_is_valid_shielded_address(const char *address, uint32_t network_id);
 ...
 * - The memory referenced by `address` must not be mutated for the duration of the function call.
 */
bool lrzhs_is_valid_transparent_address(const char *address, uint32_t network_id);
 ...
 *   function call.
 */
bool lrzhs_is_valid_unified_address(const char *address, uint32_t network_id);
 ...
 *   function call.
 */
bool lrzhs_is_valid_unified_full_viewing_key(const char *ufvk, uint32_t network_id);
 ...
 */
bool lrzhs_is_valid_viewing_key(const char *key, uint32_t network_id);

/**
 * Returns the length of the last error message to be logged.
 */
int32_t lrzhs_last_error_length(void);
 ...
 *   when done using it.
 */
FFIEncodedKeys *lrzhs_list_transparent_receivers(const uint8_t *db_data,
                                                 uintptr_t db_data_len,
                                                 int32_t account_id,
                                                 uint32_t network_id);
 ...
 *   documentation of pointer::offset.
 */
bool lrzhs_put_utxo(const uint8_t *db_data,
                    uintptr_t db_data_len,
 ...
 *   documentation of pointer::offset.
 */
bool lrzhs_rewind_to_height(const uint8_t *db_data,
                            uintptr_t db_data_len,
                            int32_t height,
                            uint32_t network_id);
 ...
 *   documentation of pointer::offset.
 */
int32_t lrzhs_scan_blocks(const uint8_t *db_cache,
 ...
 *   documentation of pointer::offset.
 */
int64_t lrzhs_shield_funds(const uint8_t *db_data,
                           uintptr_t db_data_len,
                           const uint8_t *usk_ptr,
                           uintptr_t usk_len,
                           const uint8_t *memo,
 ...
 */
char *lrzhs_spending_key_to_full_viewing_key(const uint8_t *usk_ptr,
                                             uintptr_t usk_len,
                                             uint32_t network_id);
 ...
 *   documentation of pointer::offset.
 */
int32_t lrzhs_validate_combined_chain(const uint8_t *db_cache,
                                      uintptr_t db_cache_len,
                                      const uint8_t *db_data,
                                      uintptr_t db_data_len,
                                      uint32_t network_id);
